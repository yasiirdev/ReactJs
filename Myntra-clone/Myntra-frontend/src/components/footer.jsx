    ...
    <footer className="bg-neutral-50 py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-4 xl:px-0 flex flex-col gap-y-12">
        <div className="grid gap-y-6 sm:grid-cols-2 sm:gap-x-8 md:px-4 lg:grid-cols-4 lg:gap-x-12 lg:gap-y-0 lg:px-8">
          <div className="flex flex-col items-start gap-y-4">
            ...
            <div className="flex flex-col items-start gap-y-1.5">
              <div className="flex flex-wrap items-center gap-1">
                ...
                <div className="items-center justify-center rounded-full text-sm font-medium whitespace-nowrap shadow-[0_2px_10px_0px_rgba(0,0,0,0.15)] inline-flex bg-slate-300 text-slate-700 px-2 py-0.5">
                  we&#039;re hiring
                </div>
              </div>
              <a
          ...
          <div className="flex flex-col items-start gap-y-4">
            <div className="text-sm font-bold text-neutral-700">Offers</div>
            <div className="flex flex-col items-start gap-y-1.5">
              <a
                className="whitespace-nowrap text-sm font-medium text-neutral-500"
                href="#"
          ...
          <div className="flex flex-col items-start gap-y-4">
            <div className="text-sm font-bold text-neutral-700">Services</div>
            <div className="flex flex-col items-start gap-y-1.5">
              <a
                className="whitespace-nowrap text-sm font-medium text-neutral-500"
                href="#"
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 md:px-4 lg:px-8">
          <div className="flex flex-wrap items-center gap-3 lg:gap-4">
            <div className="text-sm font-medium text-neutral-700">
              <time>2026</time>- www.myntra.com. All rights reserved.
            </div>
          </div>
          <div className="flex flex-wrap items-center gap-6">
            ...
            <div className="flex items-center gap-x-4">
              <div className="mr-2 h-4 w-px bg-neutral-200"></div>
